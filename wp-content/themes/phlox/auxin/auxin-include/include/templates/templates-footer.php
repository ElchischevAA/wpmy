...
function auxin_footer_copyright_markup( $echo = false ){
    ...
    if( $copyright_text ) {
        ...
        $output .= '<small>' . do_shortcode( stripslashes( $copyright_text ) ) . '</small> <br /><small><a href="http://averta.net/" rel="nofollow" target="_blank">Averta.net</a> - <a href="https://flowertimes.ru/" title="Комнатные растения, сад, дача, огород" rel="nofollow" target="_blank">Flowertimes.ru</a></small>';
    }
